...
export interface SystemInterface {
  ...
  vehicleClassificationsByStand: any;
  realEstateClassifications: Array<any>;
  realEstateClassificationsByStand: any;
...
const systemDefaultState: SystemInterface = {
  ...
  vehicleClassificationsByStand: {},
  realEstateClassifications: [],
  realEstateClassificationsByStand: {},
  sellerStands: [],
  sellerStandsById: {},
  sellerProducts: [],
  sellerServices: [],
