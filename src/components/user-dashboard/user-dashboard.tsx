...
import LoadUserCart from 'src/components/user-cart/load-user-cart';
import LoadUserAddress from 'src/components/user-address/load-user-address';
import LoadMyStands from 'src/components/my-stands/load-my-stands';
